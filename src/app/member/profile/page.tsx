...
import testImage from '../../../../public/testing.webp'
    ...
    return (
        <div className="h-full w-full flex flex-col justify-between">
            ...
            <div className="flex flex-row items-center space-x-4 mx-8">
                <div>
                    <Image className="w-[96px] h-[96px] rounded-full" src={testImage} alt="User Profile Picture" />
                </div>
                <div className="flex flex-col text-black">
                    <h2 className="font-semibold text-3xl">Username</h2>
                    <p className="text-lg">Member Since March 2022</p>
                </div>
            </div>
